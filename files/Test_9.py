...
with open(r'C:\Users\Brian\Desktop\Bitcoin Datasets\allData.csv', newline = '', mode = 'r+') as csvFile:
...
mu = np.mean(returns) * 1818. #working days from 1/1/2011 to 3/30/2018
sigma = np.std(returns) * np.sqrt(1818.) 
